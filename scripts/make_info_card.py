...
# ===========================================================================
HOST = "abrez-rizvi"   # shown as  abrez-rizvi@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "builder of slop & systems"),
    ("kv", "Loc", "Lucknow, India"),
    ("kv", "Site", "github.com/abrez-rizvi"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Code", "Python, TypeScript"),
    ("kv", "Web/App", "React, Node.js, Electron"),
    ("kv", "Tools", "Tree-sitter, NetworkX, YAML"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building Knowiki"),
    ("bul", "Shipping in public"),
    ("bul", "Building knowledge layer for codebases"),
    ("bul", "Likes clean terminals & bad jokes"),
]
